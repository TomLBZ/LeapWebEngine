...
export class Game {
    ...
    InitializeECS() {
        this.world.AddEntity(new Entity("PLAYER", [
            new GeneralComponents.SphereColliderComponent(0.1),
            new GeneralComponents.SDFRenderComponent(SDF_ID.SPHERE, { "radius": 0.1 }, new Material(null, [0.5, 0.5, 1., 0.7])),
        ...
        this.world.AddSingletonComponent(new GeneralComponents.WorldSDFColliderComponent([SDF_ID.INF_CUBES,SDF_ID.TUNNEL]));
