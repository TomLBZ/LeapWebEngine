...
export class Mat3 extends Matrix{
    ...
    static RotMatX(angle){
        return new Mat3([1,         0,          0,
            0,              Math.cos(angle),            -Math.sin(angle),
            0,              Math.sin(angle),            Math.cos(angle)]);    
    }
    static RotMatY(angle){
...
export class Vectors{
    ...
    Add(v){
        return new this(vectorAdd(this.Elements, v.Elements));
    }
    Minus(v){
        return new this(vectorMinus(this.Elements, v.Elements));
    }
    Norm(){
        return new this(vectorNormalize(this.Elements));
    }
    ToArray(){
