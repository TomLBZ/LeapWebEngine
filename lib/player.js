import { vector3Cross, Vec3 } from './matrix.js';
...
export class Player{
    constructor(window, camera, bobject, canvas){
        ...
        this.TranslationalDecayFactor = 0.9;
        this.Accel = 0.0001;
        this.AngularSpeed = 1.;
        this.RotAngX = 0.;
        this.RotAngY = 0.;
        this.RotationalDecayFactor = 0.8;
        this.Canvas = canvas;
    ...
    RedirectMousemoveEvent(event){
        ...
        this.RotAngX = dy / this.BaseWindow.innerWidth * Math.PI;
        this.RotAngY = -dx / this.BaseWindow.innerHeight * Math.PI;
    }
