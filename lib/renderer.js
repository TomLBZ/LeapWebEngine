        ...
        for (let matType in MatType) {
            ...
            if (!this.gl.getProgramParameter(program, this.gl.LINK_STATUS)) {
                ...
                this.uniformLocationsByMatType[matType] = {
                    ...
                    "diffuseColor": this.gl.getUniformLocation(program, 'diffuseColor')
                };
    ...
    renderScene(scene, camera) {
        ...
        for (let i = 0; i < objectGroups.length; i++) {
            ...
            for (let j = 0; j < group.length; j++) {
                ...
                let projectionMatrixUniformLocation = this.uniformLocationsByMatType[matType]['projectionMatrix'];
                let diffuseColorUniformLocation = this.uniformLocationsByMatType[matType]['diffuseColor'];
                ...
                this.gl.uniform4fv(diffuseColorUniformLocation, obj.material.diffuseColor);
