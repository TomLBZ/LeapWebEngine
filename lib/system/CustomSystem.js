...
export class PlayerUpdateSystem extends System{
    ...
    update(inputComp, rigidbodyComp) {
        ...
        rigidbodyComp.w[0] += mouseState["yaw"] * CAM_DEFAULTS.ROT_DW;
        rigidbodyComp.w[1] += mouseState["pitch"] * CAM_DEFAULTS.ROT_DW;
        rigidbodyComp.w[0] *= CAM_DEFAULTS.ROT_DECAY;
        rigidbodyComp.w[1] *= CAM_DEFAULTS.ROT_DECAY;
    }
}
