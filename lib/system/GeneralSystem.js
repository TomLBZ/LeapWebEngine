...
export class TransformUpdateSystem extends System{
    ...
    update(globalPhysicsComp, cameraComp, rigidbodyComp, transformComp) {
        //向量运算，更新transform
        transformComp.position[0] += globalPhysicsComp.deltaTime * rigidbodyComp.velocity[0];
        transformComp.position[1] += globalPhysicsComp.deltaTime * rigidbodyComp.velocity[1];
        transformComp.position[2] += globalPhysicsComp.deltaTime * rigidbodyComp.velocity[2];
        cameraComp.camera.pos = transformComp.position;
        transformComp.rotation[0] += globalPhysicsComp.deltaTime * rigidbodyComp.w[0];
        transformComp.rotation[1] += globalPhysicsComp.deltaTime * rigidbodyComp.w[1];
        cameraComp.camera.yaw(transformComp.rotation[0]);
        cameraComp.camera.pitch(transformComp.rotation[1]);
    }
}
...
export class RigidBodyUpdateSystem extends System{
    ...
    update(deltaTime, forceComp, rigidbodyComp) {
        //向量运算，更新rigidbody
    }
}
...
export class SphereCollisionTestingSystem extends System{
    ...
    update(worldColComp, forceComp, rigidbodyComp, sphereColComp, transformComp) {
