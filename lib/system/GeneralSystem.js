...
*/
        ...
        let intersection = SDF_DICT[SDF_ID.INF_CUBES](nextpos) - sphereColComp.radius;
        console.log("# sdf_intersection = ", intersection);
        if (intersection < 0.0) {
            ...
            let val1 = VectorFunctions.vecScale([1,-1,-1],SDF_DICT[SDF_ID.INF_CUBES](tmp1));
            let val2 = VectorFunctions.vecScale([-1,-1,1],SDF_DICT[SDF_ID.INF_CUBES](tmp2));
            let val3 = VectorFunctions.vecScale([-1,1,-1],SDF_DICT[SDF_ID.INF_CUBES](tmp3));
            let val4 = VectorFunctions.vecScale([1, 1, 1],SDF_DICT[SDF_ID.INF_CUBES](tmp4));
            let fn_mag = intersection * sphereColComp.stiffness;
            let fdir = VectorFunctions.vecNormalize(VectorFunctions.vecSum([val1,val2,val3,val4]));
            let fn = VectorFunctions.vecScale(fdir, fn_mag);
            console.log("# fdir = ", fdir);
            console.log("# fn = ", fn);
            forceComp.force = VectorFunctions.vecAdd(forceComp.force, fn);
        }
        //TODO: 
